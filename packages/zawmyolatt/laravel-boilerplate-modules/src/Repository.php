...
use Zawmyolatt\Modules\Exceptions\InvalidAssetPath;
use Zawmyolatt\Modules\Exceptions\ModuleNotFoundException;
use Zawmyolatt\Modules\Process\Installer;
use Zawmyolatt\Modules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
    ...
    public function getScanPaths() : array
    {
        ...
        $paths = array_map(function ($path) {
            return str_ends_with($path, '/*') ? $path : Str::finish($path, '/*');
        }, $paths);
     ...
     * @param $name
     * @param $path
     * @return \Zawmyolatt\Modules\Module
     */
     ...
     * @return string
     * @throws \Zawmyolatt\Modules\Exceptions\ModuleNotFoundException
     */
