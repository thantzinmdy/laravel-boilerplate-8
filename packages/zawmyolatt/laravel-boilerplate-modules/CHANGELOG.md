...
All Notable changes to `laravel-boilerplate-modules` will be documented in this file.
...
- Laravel mix configuration (https://Zawmyolatt.com/laravel-boilerplate-modules/v3/basic-usage/compiling-assets)
...
- updated readme on how to install laravel-boilerplate-modules in Lumen
...
- Module generation namespace now works with `StudlyCase` ([Issue #14](https://github.com/Zawmyolatt/laravel-boilerplate-modules/issues/14))
